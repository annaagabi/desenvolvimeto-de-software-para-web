<?php
    ...
    // Receber o código da tarefa a ser excluída
...
<body>
    <div class="login-container">
        ...
        <form method="get" action="excluiTarefa.php">
            <div class="mb-3">
                <label for="tarefa" class="form-label">Nome da Tarefa</label>
                <input type="text" name="tarefa" id="tarefa" maxLength="100" size=50 class="form-control" value="<?= $resultado['tarefa']; ?>" readonly> 
                <!-- O "readonly" faz com que o usuário não possa digitar nada no input, apenas ler os valores passados -->
            </div>
            <div class="mb-3">
                <label for="inicio" class="form-label">Data de Inicio</label>
                <input type="date" name="inicio" id="inicio" class="form-control" value="<?= $resultado['inicio']; ?>" readonly>
            </div>
            <div class="mb-3">
                <label for="termino" class="form-label">Data de Término</label>
                <input type="date" name="termino" id="termino" class="form-control" value="<?= $resultado['termino']; ?>" readonly>
            </div>
