...
<?php 
        while ( $result = $select->fetch()) {
            ...
            echo "<tr style='padding: 10px;'>" ;
                ...
                echo "<td style='padding: 10px; text-align:center'>".date('d/m/y', strtotime($termino))."</td>";
    ...
    try {
        ...
        while ($result = $select->fetch()) {
            ...
            echo "<tr>";
                ...
                echo "<td style='text-align:center;'><a href='editar.php?idTarefa=$idTarefa'><img src='assets/imagens/lapis.png' style='width: 40%;' title='Altera a tarefa'></a></td>";
                echo "<td style='text-align:center;'><a href='excluir.php?idTarefa=$idTarefa'><img src='assets/imagens/lixo.png' style='width: 40%;' title='Exclui a tarefa'></a></td>";
